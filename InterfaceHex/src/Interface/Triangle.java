...
public class Triangle extends JPanel { 
	  ...
	  public void paint(Graphics arg0){                
			  ...
			  for (int i=0; i<this.taille-1; i++){
				  ...
				  Point p5 = new Point ( taille*44+(taille-2)*22+21, 11+(taille-2)*39+39); 
				  Point p6 = new Point ( taille*44+(taille-2)*22+39, 11+(taille-2)*39+80);
				  Point p7 = new Point ( taille*44+(taille-2)*22+21, 11+(taille-2)*39+70); 
				  Point p8 = new Point ( taille*44+(taille-2)*22+39, 11+(taille-2)*39+51); 
				 
				  int [] x2 = { p5.x , p7.x , p6.x , p8.x}; 
				  int [] y2 = { p5.y , p7.y , p6.y , p8.y };
				  
				  Polygon pl2 = new Polygon ( x2 , y2, 4 ) ; 
				  arg0.setColor(Color.black);
				  arg0.fillPolygon(pl2);
				  
				  Point p9 = new Point ( taille*44+(taille-2)*22+39, 11+(taille-2)*39+80); 
				  Point p10 = new Point ( taille*44+(taille-2)*22+21, 11+(taille-2)*39+70); 
				  Point p11 = new Point ( 23+22*(taille-1)+44*(taille-2)+44, 39+39*(taille-1)+14);
				  Point p12 = new Point ( 23+22*(taille-1)+44*(taille-2)+44+14, 39+39*(taille-1)+14+8);

				  int [] x3 = { p9.x , p10.x , p11.x, p12.x }; 
				  int [] y3 = { p9.y , p10.y , p11.y, p12.y };

				  Polygon p = new Polygon ( x3 , y3, 4 ) ; 
				  arg0.setColor(Color.white);
				  arg0.fillPolygon(p);
